    ...
    >
      ...
      <div className={"px-10 pt-10 pb-5"}>
        <div className={"flex items-start gap-5 mb-5"}>
          <div className={"w-[140px] h-[140px] max-w-[140px] max-h-[140px] rounded-2xl flex" +
            " items-center justify-center"} style={{backgroundColor: themeColors[1]}}>
            {resumeData.profileInfo.profilePreviewUrl ? (
              <img src={resumeData.profileInfo.profilePreviewUrl} alt={"User Profile Image"}
                   className={"w-[140px] h-[140px] rounded-2xl"}/>
            ) : (
              <div className={"w-[140px] h-[140px] flex items-center justify-center text-5xl" +
        ...
        <div className="mt-5">
          ...
          <div className={"grid grid-cols-2 gap-3"}>
            {resumeData.education.map((data, index) => (
              <EducationInfo
                key={`education_${index}`} degree={data.degree}
